...
MAKECMD         = /Applications/MATLAB_R2023b.app/bin/maci64/gmake
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = foc
MODULES                 = foc.c foc_capi.c foc_data.c foc_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = foc
MAKEFILE                = foc.mk
MATLAB_ROOT             = /Applications/MATLAB_R2023b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2023b.app
START_DIR               = /Users/yangqingyao/Public/zbn/STM32CubeMX-Demo/matlab
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
COMPUTER                = MACI64
...
ADDITIONAL_LDFLAGS      =  -Wl,-rpath,/Applications/MATLAB_R2023b.app/bin/maci64 -Wl,-rpath,/Applications/MATLAB_R2023b.app/sys/os/maci64 -Wl,-rpath,@executable_path -Wl,-rpath,@executable_path/../../.. -L/Applications/MATLAB_R2023b.app/sys/os/maci64
